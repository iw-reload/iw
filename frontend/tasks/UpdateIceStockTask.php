 ...
 * @author ben
 */
class UpdateIceStockTask extends AbstractTask implements TaskInterface
{
  /**
   * @var Resources 
   */
  ...
  public function execute($params)
  {
    ...
    $iceProductionPerSecond = $production->ice / 3600;
    ...
    $ice = $this->stock->ice + $iceProductionPerSecond * $timeInSeconds;
    $this->stock->ice = \min( $ice, $storage->ice );
  }
